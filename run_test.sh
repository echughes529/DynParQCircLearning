#!/bin/bash
#SBATCH --job-name=dpqc-nan-debug
...
# --- Run code ---
# Edit the RUN_SECTION_*/LIVE_*/FORCE_CPU toggles at the top of
# src/examples/test.py before submitting -- this just runs whatever is
# currently toggled on in that file (Section 4, the live training
# diagnostic, needs RUN_SECTION_4 = True to do anything on a GPU node).
